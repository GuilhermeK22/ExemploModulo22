...
public class Pessoa {
    ...
    public List<Pessoa> popularPessoas(){
        ...
        Pessoa pessoa2 =new Pessoa("p2", "Hernandez", "Mexico", 22);
        Pessoa pessoa3 =new Pessoa("p3", "Mario", "Canada", 21);
        Pessoa pessoa4 =new Pessoa("p4", "Neymar", "Brasil", 30);
        Pessoa pessoa5 =new Pessoa("p5", "Ana", "EUA", 23);
        Pessoa pessoa6 =new Pessoa("p6", "Maria", "Brasil", 40);
